...
<section class="banner-section" style="padding-top:150px; padding-bottom:0px;">
    ...
    <div class="container">
        <div class="banner-content">
            ...
            <!-- Timer -->
            <div class="mt-3">
                <span class="timer badge" id="countdown-timer" style="background: #dc3545; font-size: 16px; padding: 10px 20px; border-radius: 25px;">15:00</span>
                <p class="mt-2" style="font-size: 14px; color: #f39c12;">Complete your booking before time expires</p>
            </div>

            <p style="font-size:22px; color: #f39c12;">Enter Your Details</p>
        </div>
    </div>
</section>
