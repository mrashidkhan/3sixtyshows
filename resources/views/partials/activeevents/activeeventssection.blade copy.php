...
<section class="event-section padding-bottom" style="padding-top:60px;">
                                ...
                                <div class="event-grid" style="height: 510px;">
                                    <div class="movie-thumb c-thumb" style="height: 357px;">
                                        ...
                                        @if ($show->featured_image)
                                            <img src="{{ asset('storage/' . $show->featured_image) }}" height="420"
                                                alt="{{ $show->title }}">
                                        @else
    ...
    @php $venueName = $show->venue?->name ?? 'Venue TBA'; @endphp
    <span>{{ strlen($venueName) > 20 ? substr($venueName, 0, 20) . '...' : $venueName }}</span>
</div>
                                    </div>
                                @empty
