        ...
        <div class="tab">
            <div class="section-header-2">
                <div class="left">
                    ...
                    <p class="heading-color" style="font-size:12px;">Mark your calendar for these upcoming events in the
                        next quarter.</p>
                </div>
                <ul class="tab-menu">
                    <li class="active">
                        ...
                        @forelse($recentEvents as $event)
                                    ...
                                    <div class="movie-thumb c-thumb">
                                        ...
                                        @else
                                            <div class="no-image-placeholder"
                                                style="height: 420px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); display: flex; align-items: center; justify-content: center; color: white;">
                                                <div style="text-align: center;">
                                                    <i class="fas fa-calendar-alt"
                                                        style="font-size: 48px; margin-bottom: 10px; opacity: 0.8;"></i>
                                                    <p style="margin: 0; font-size: 14px; opacity: 0.9;">
                                                        {{ Str::limit($event->title, 15) }}</p>
                                                </div>
                                            </div>
                                        @endif
                                        </a>
                                        <div class="event-date">
                                            ...
                                            @if ($event->start_date->year != now()->year)
                                                <span
                                                    style="color:white; font-size: 12px;">{{ $event->start_date->format('Y') }}</span>
                                            @endif
                                        </div>
                                    </div>
                            ...
                            @empty
                                <div class="item">
                                    <div class="event-grid">
                                        <div class="movie-thumb c-thumb"
                                            style="height: 420px; background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); display: flex; align-items: center; justify-content: center;">
                                            <div style="text-align: center; color: white;">
                                                <i class="fas fa-calendar-plus"
                                                    style="font-size: 48px; margin-bottom: 15px; opacity: 0.8;"></i>
                                                <h4 style="margin: 0;">No Upcoming Events</h4>
                                                <p style="margin: 5px 0 0 0; opacity: 0.9;">Check back soon for new events!
                                                </p>
                                            </div>
                                        </div>
                                        <div class="movie-content bg-one">
                                            ...
                                            <div class="movie-rating-percent" style="justify-content:center">
                                                <a href="{{ route('activeevents') }}" class="custom-button">browse all
                                                    events</a>
                                            </div>
                                        </div>
                                    </div>
