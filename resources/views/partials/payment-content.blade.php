<!-- ==========Payment Content========== -->
{{-- File: resources/views/partials/payment-content.blade.php --}}
                ...
                <div class="col-lg-7">
                    <div class="event-about-content">
                        ...
                        <div class="customer-info-display mb-4" style="background: #f8f9fa; padding: 20px; border-radius: 10px; border-left: 4px solid #28a745;">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <p class="mb-2"><strong>Name:</strong> {{ $customerData['name'] }}</p>
                                    <p class="mb-0"><strong>Email:</strong> {{ $customerData['email'] }}</p>
                                </div>
                                <div class="col-md-6">
                                    <p class="mb-2"><strong>Phone:</strong> {{ $customerData['phone'] }}</p>
                                    <p class="mb-0">
                        ...
                        <!-- Credit Card Form (Will be populated in next chunk) -->
                        <div class="card-form-section" id="card-form" style="display: block;">
                            <h6 style="color: #1a1a2e; margin-bottom: 20px;">Card Information</h6>
                            <!-- Card form fields will go here in next chunk -->
                            <div class="text-center py-4" style="background: #f8f9fa; border-radius: 8px; border: 2px dashed #dee2e6;">
                                <i class="fas fa-credit-card fa-2x text-muted mb-2"></i>
                                <p class="text-muted mb-0">Card form will be implemented in next step</p>
                            </div>
                        </div>
